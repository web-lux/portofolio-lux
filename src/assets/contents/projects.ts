export const projects = [
	...
	},
	{
		...
		id: "6",
		skillset: "dev",
		previewText: `Application React pour le jeu de rôle Ironsworn : Starforged. Elle permet de créer des assets personnalisés pour le jeu tout en respectant son esthétique et cela sans avoir besoin de compétences et logiciels graphiques.`,
	...
	},
	{
		...
		id: "7",
		skillset: "dev",
		previewText: `Application Météo écrite sous React avec géolocalisation et appels API.`,
	...
	},
	{
		...
		id: "8",
		skillset: "dev",
		previewText: `Implémentation d'une partie de l'e-commerce fictif <b>Run'Zik</b> basée sur la maquette éponyme (que vous pouvez retrouver dans mes projets de design). Construit sous React.`,
	...
	},
	{
		...
		id: "9",
		skillset: "dev",
		previewText: `Application de suivi de lectures écrite en javascript vanilla. Les utilisateurs peuvent y ajouter leurs livres lus et à lire et mettre à jour le badge de statut en un clic.`,
	...
	},
	{
		...
		id: "10",
		skillset: "dev",
		previewText: `Petit jeu de dessin à la souris inspiré des écrans magiques (ou <i>etch-a-sketch</i> en anglais) écrit en javascript vanilla.`,
