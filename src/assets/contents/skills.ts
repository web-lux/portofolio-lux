export const skills = [
	...
	},
	{
		title: "Design UX • UI",
		description:
			"Créer des supports de communication pour un client, la charte graphique de son entreprise ou les ressources nécessaires à certaines sections de son site internet comme des pictogrammes, ou des photographies dont les couleurs ont été harmonisées par logiciel.",
